"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.hasNoMessage=exports.hasMessage=exports.findMessage=void 0;const section_1=require("./section");function findMessage(messages,constructPath,props={}){const section=messages,result=section_1.matchSection(filterPath(section,constructPath),props);return result.match?result.matches:{}}exports.findMessage=findMessage;function hasMessage(messages,constructPath,props){const section=messages,result=section_1.matchSection(filterPath(section,constructPath),props);if(!result.match){for(const mr of Object.values(result.closestResults))redactTraces(mr.target);return section_1.formatSectionMatchFailure(`messages at path ${constructPath}`,result,"Stack")}}exports.hasMessage=hasMessage;function hasNoMessage(messages,constructPath,props){const section=messages,result=section_1.matchSection(filterPath(section,constructPath),props);if(result.match)return[`Expected no matches, but stack has ${Object.keys(result.matches).length} messages as follows:`,section_1.formatAllMatches(result.matches)].join(`
